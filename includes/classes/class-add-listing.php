...
if ( ! class_exists( 'ATBDP_Add_Listing' ) ) :
    ...
    class ATBDP_Add_Listing {
        ...
        public function __construct() {
            ...
            add_action( 'wp_ajax_directorist_upload_listing_image', [ __CLASS__, 'upload_listing_image' ] );
            add_action( 'wp_ajax_nopriv_directorist_upload_listing_image', [ __CLASS__, 'upload_listing_image' ] );
        }
        ...
        public static function upload_listing_image() {
            try {
                ...
                add_filter( 'upload_dir', [ __CLASS__, 'set_temporary_upload_dir' ] );
                ...
                remove_filter( 'upload_dir', [ __CLASS__, 'set_temporary_upload_dir' ] );
         ...
         * @return array
         */
        public function show_current_user_attachments( array $query = [] ) {
        ...
        public function handle_listing_renewal() {
            ...
            if ( ! in_array( $renew_from, [ 'email', 'dashboard' ], true ) ) {
                return;
            }

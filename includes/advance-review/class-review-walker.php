		...
		<li id="comment-<?php comment_ID(); ?>" <?php comment_class( $comment_class ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				...
				<footer class="directorist-review-single__feedback">
					<a role="button" href="#" class="directorist-btn directorist-btn-outline-dark"><i class="far fa-thumbs-up"></i> Helpful <span>6</span></a>
					<a role="button" href="#" class="directorist-btn directorist-btn-outline-dark"><i class="far fa-thumbs-down"></i> Not Helpful <span>2</span></a>
				</footer>
